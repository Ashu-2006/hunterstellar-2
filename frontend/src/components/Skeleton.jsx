...
export function ClueSkeleton() {
  return (
    <div className="w-full px-6 py-6 flex flex-col gap-6" role="status" aria-label="Loading clue">
...
export function LeaderboardSkeleton({ rows = 6 }) {
  return (
    <div className="w-full flex flex-col gap-3 px-6" role="status" aria-label="Loading leaderboard">
