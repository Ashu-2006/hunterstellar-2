      ...
      <div className="flex-1 flex flex-col px-6 py-6 gap-6 overflow-y-auto">
        <div>
          ...
          <p className="text-text-muted text-sm mt-2">
            {complete
              ? 'All four recovered. The assembled message is below.'
        ...
        <div className="flex flex-col gap-3">
          {Array.from({ length: FRAGMENT_COUNT }, (_, i) => i + 1).map((index) => {
            ...
            return (
              <div
                key={index}
                className={`w-full rounded-md border px-4 py-4 flex flex-col gap-2 ${
                  isUnlocked
                    ? 'border-accent/40 card-noise'
              ...
              >
                ...
                {isUnlocked ? (
                  <p className="text-text-primary text-[15px] leading-relaxed whitespace-pre-line">
